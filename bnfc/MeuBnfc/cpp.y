...
%token _SYMB_17    //   ate
%token _SYMB_18    //   bool
%token _SYMB_19    //   claudiz
%token _SYMB_20    //   double
%token _SYMB_21    //   false
%token _SYMB_22    //   int
%token _SYMB_23    //   para
%token _SYMB_24    //   receba
%token _SYMB_25    //   return
%token _SYMB_26    //   se
%token _SYMB_27    //   senao
%token _SYMB_28    //   string
%token _SYMB_29    //   true
%token _SYMB_30    //   void
%token<string_> _SYMB_31    //   Id
...
%%
Program : ListDef {  $$ = pDefs_($1); YY_RESULT_Program_= $$; }
;
Def : Type _SYMB_31 _SYMB_0 ListArg _SYMB_1 _SYMB_2 ListStm _SYMB_3 {  std::reverse($4->begin(),$4->end()) ;$$ = new DFun($1, $2, $4, $7); YY_RESULT_Def_= $$; }
;
ListDef : /* empty */ {  $$ = new ListDef(); YY_RESULT_ListDef_= $$; }
  | ListDef Def {  $1->push_back($2) ; $$ = $1 ; YY_RESULT_ListDef_= $$; }
;
Arg : Type _SYMB_31 {  $$ = new ADecl($1, $2); YY_RESULT_Arg_= $$; }
;
...
Stm : Exp _SYMB_5 {  $$ = new SExp($1); YY_RESULT_Stm_= $$; }
  ...
  | Type _SYMB_31 _SYMB_6 Exp _SYMB_5 {  $$ = new SInit($1, $2, $4); YY_RESULT_Stm_= $$; }
  | _SYMB_25 Exp _SYMB_5 {  $$ = new SReturn($2); YY_RESULT_Stm_= $$; }
  | _SYMB_25 _SYMB_5 {  $$ = new SReturnVoid(); YY_RESULT_Stm_= $$; }
  | _SYMB_17 _SYMB_0 Exp _SYMB_1 Stm {  $$ = new SAte($3, $5); YY_RESULT_Stm_= $$; }
  | _SYMB_23 _SYMB_0 ListExp _SYMB_5 ListExp _SYMB_5 ListExp _SYMB_1 Stm {  std::reverse($3->begin(),$3->end()) ; std::reverse($5->begin(),$5->end()) ; std::reverse($7->begin(),$7->end()) ;$$ = new SFor($3, $5, $7, $9); YY_RESULT_Stm_= $$; }
  | _SYMB_2 ListStm _SYMB_3 {  $$ = new SBlock($2); YY_RESULT_Stm_= $$; }
  | _SYMB_26 _SYMB_0 Exp _SYMB_1 Stm _SYMB_27 Stm {  $$ = new SSeSenao($3, $5, $7); YY_RESULT_Stm_= $$; }
  | _SYMB_19 _SYMB_0 Exp _SYMB_1 _SYMB_5 {  $$ = new SClaudiz($3); YY_RESULT_Stm_= $$; }
  | _SYMB_24 _SYMB_0 Type ListId _SYMB_1 _SYMB_5 {  std::reverse($4->begin(),$4->end()) ;$$ = new SReceba($3, $4); YY_RESULT_Stm_= $$; }
;
...
Exp15 : _SYMB_29 {  $$ = new ETrue(); YY_RESULT_Exp_= $$; }
  | _SYMB_21 {  $$ = new EFalse(); YY_RESULT_Exp_= $$; }
  | _INTEGER_ {  $$ = new EInt($1); YY_RESULT_Exp_= $$; }
  | _DOUBLE_ {  $$ = new EDouble($1); YY_RESULT_Exp_= $$; }
  | _STRING_ {  $$ = new EString($1); YY_RESULT_Exp_= $$; }
  | _SYMB_31 {  $$ = new EId($1); YY_RESULT_Exp_= $$; }
  | _SYMB_31 _SYMB_0 ListExp _SYMB_1 {  std::reverse($3->begin(),$3->end()) ;$$ = new EApp($1, $3); YY_RESULT_Exp_= $$; }
  | _SYMB_0 Exp _SYMB_1 {  $$ = $2; YY_RESULT_Exp_= $$; }
;
Exp12 : Exp12 _SYMB_7 Exp13 {  $$ = new ETimes($1, $3); YY_RESULT_Exp_= $$; }
  | Exp12 _SYMB_8 Exp13 {  $$ = new EDiv($1, $3); YY_RESULT_Exp_= $$; }
  | Exp13 {  $$ = $1; YY_RESULT_Exp_= $$; }
;
Exp11 : Exp11 _SYMB_9 Exp12 {  $$ = new EPlus($1, $3); YY_RESULT_Exp_= $$; }
  | Exp11 _SYMB_10 Exp12 {  $$ = new EMinus($1, $3); YY_RESULT_Exp_= $$; }
...
Exp8 : Exp8 _SYMB_15 Exp9 {  $$ = new EEq($1, $3); YY_RESULT_Exp_= $$; }
  | Exp7 _SYMB_16 Exp8 {  $$ = new ENEq($1, $3); YY_RESULT_Exp_= $$; }
...
;
Type : _SYMB_18 {  $$ = new Type_bool(); YY_RESULT_Type_= $$; }
  | _SYMB_22 {  $$ = new Type_int(); YY_RESULT_Type_= $$; }
  | _SYMB_20 {  $$ = new Type_double(); YY_RESULT_Type_= $$; }
  | _SYMB_30 {  $$ = new Type_void(); YY_RESULT_Type_= $$; }
  | _SYMB_28 {  $$ = new Type_string(); YY_RESULT_Type_= $$; }
;
ListId : _SYMB_31 {  $$ = new ListId() ; $$->push_back($1); YY_RESULT_ListId_= $$; }
  | _SYMB_31 _SYMB_4 ListId {  $3->push_back($1) ; $$ = $3 ; YY_RESULT_ListId_= $$; }
;
