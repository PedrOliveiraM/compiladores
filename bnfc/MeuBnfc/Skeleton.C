...
void Skeleton::visitSAte(SAte *s_ate)
{
  /* Code For SAte Goes Here */

  s_ate->exp_->accept(this);
  s_ate->stm_->accept(this);
...
void Skeleton::visitSFor(SFor *s_for)
{
  ...
  s_for->listexp_1->accept(this);
  s_for->listexp_2->accept(this);
  s_for->listexp_3->accept(this);
...
void Skeleton::visitSSeSenao(SSeSenao *s_se_senao)
{
  /* Code For SSeSenao Goes Here */

  s_se_senao->exp_->accept(this);
  s_se_senao->stm_1->accept(this);
  s_se_senao->stm_2->accept(this);

}

void Skeleton::visitSClaudiz(SClaudiz *s_claudiz)
{
  /* Code For SClaudiz Goes Here */

  s_claudiz->exp_->accept(this);

}

void Skeleton::visitSReceba(SReceba *s_receba)
{
  /* Code For SReceba Goes Here */

  s_receba->type_->accept(this);
  s_receba->listid_->accept(this);
