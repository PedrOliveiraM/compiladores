...
void PrintAbsyn::visitSAte(SAte *p)
{
  int oldi = _i_;
  if (oldi > 0) render(_L_PAREN);
...
void PrintAbsyn::visitSFor(SFor *p)
{
  ...
  render("para");
  render('(');
  if(p->listexp_1) {_i_ = 0; p->listexp_1->accept(this);}
  render(';');
  if(p->listexp_2) {_i_ = 0; p->listexp_2->accept(this);}
  render(';');
  if(p->listexp_3) {_i_ = 0; p->listexp_3->accept(this);}
  render(')');
  _i_ = 0; p->stm_->accept(this);
...
void PrintAbsyn::visitSSeSenao(SSeSenao *p)
{
  int oldi = _i_;
  if (oldi > 0) render(_L_PAREN);
...
void PrintAbsyn::visitSClaudiz(SClaudiz *p)
{
  int oldi = _i_;
  if (oldi > 0) render(_L_PAREN);
...
void PrintAbsyn::visitSReceba(SReceba *p)
{
  int oldi = _i_;
  if (oldi > 0) render(_L_PAREN);
...
void ShowAbsyn::visitSAte(SAte *p)
{
  bufAppend('(');
  bufAppend("SAte");
  bufAppend(' ');
...
void ShowAbsyn::visitSFor(SFor *p)
{
  ...
  bufAppend("SFor");
  bufAppend(' ');
  p->listexp_1->accept(this);
  bufAppend(' ');
  p->listexp_2->accept(this);
  bufAppend(' ');
  p->listexp_3->accept(this);
  bufAppend(' ');
  bufAppend('[');
  if (p->stm_)  p->stm_->accept(this);
  bufAppend(']');
...
void ShowAbsyn::visitSSeSenao(SSeSenao *p)
{
  bufAppend('(');
  bufAppend("SSeSenao");
  bufAppend(' ');
...
void ShowAbsyn::visitSClaudiz(SClaudiz *p)
{
  bufAppend('(');
  bufAppend("SClaudiz");
  bufAppend(' ');
...
void ShowAbsyn::visitSReceba(SReceba *p)
{
  bufAppend('(');
  bufAppend("SReceba");
  bufAppend(' ');
